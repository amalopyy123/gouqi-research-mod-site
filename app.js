(() => {
  ...
  const datasets = {
    ...
    craftArmor: { label: '合成防具', file: '合成防具.csv', columns: ['产物ID', '中文产物名称', '产物种类', '配方ID', '中文合成方案'] },
    craftWeapons: { label: '合成武器', file: '合成武器.csv', columns: ['产物ID', '中文产物名称', '产物种类', '配方ID', '中文合成方案'] },
    craftItems: { label: '合成物品', file: '合成物品.csv', columns: ['产物ID', '中文产物名称', '产物种类', '配方ID', '中文合成方案'] },
